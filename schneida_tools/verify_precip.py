...
def grid_sumup2wfde5(xlim=140, ylim=140, axes=None):
    ...
    axes[2,1].text(xlim/28., ylim - ylim/4. - 3,
          '$n$ = %d\n$r^2$ = %s\nMAE = %s cm yr$^{-1}$\nbias = %s cm yr$^{-1}$'
    ...
    axes[3,1].text(xlim/28., ylim - ylim/4. - 3.,
          '$n$ = %d\n$r^2$ = %s\nMAE = %s cm yr$^{-1}$\nbias = %s cm yr$^{-1}$'
